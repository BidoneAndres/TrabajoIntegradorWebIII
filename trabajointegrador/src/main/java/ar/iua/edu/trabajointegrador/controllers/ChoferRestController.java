...
import ar.iua.edu.trabajointegrador.model.business.implementations.ChoferBusiness;
...
@Tag(name = "Chofer", description = "API para Gestion de Choferes")
@Slf4j
@RestController
@RequestMapping(Constants.URL_CHOFERES)
public class ChoferRestController {

    @Autowired ChoferBusiness choferBusiness;

    @Operation(
            operationId = "listar-choferes",
            summary = "Lista choferes",
            description = "Lista los choferes.")
    @ApiResponses(value = {
    @ApiResponse(responseCode = "200", description = "Lista obtenida correctamente.",
        content = @Content(mediaType = "application/json", schema = @Schema(implementation = Chofer.class))),
