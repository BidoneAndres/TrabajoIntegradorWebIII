...
//La UserDetails es una interfaz que lo hace compatible con el manejo de cuentas de spting (los datos minimos)
public class User implements UserDetails {
	...
	public static final String VALIDATION_LOCKED = "LOCKED"; //Referencia a un tiempo corto
	public static final String VALIDATION_DISABLED = "DISABLED"; //basicamente es un tiempo mas largo tambien hay gente que no distingue esto
